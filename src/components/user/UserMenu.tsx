  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-2 rounded-full px-3 py-1 bg-white shadow-sm hover:bg-gray-300 transition-all border border-gray-200"
      >
        <img
          src={profileImage}
          alt="Profile"
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-xl ring-1 ring-neutral-400 ring-opacity-5 z-50 animate-fade-in p-2">
          <div className="text-sm text-center px-2 py-0.5 text-gray-600 border-b-2">
            {user.email}
          </div>
          <button
